...
- After Change 003, each later change requires user approval before implementation.
...
- Treat all user-provided memorial material as private by default.
- Do not upload private files to third-party services unless the user approves.
- Do not include confidential personal data in hosted outputs.
- Keep final artifacts separate from raw extraction work.
