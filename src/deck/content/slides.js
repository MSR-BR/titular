...
window.MemorialDeckSlides = [
  ...
  },
  {
    ...
    cards: [
      ...
      { label: "Projetos por agência", className: "agency-summary-card", html: "<div class=\"agency-breakdown\"><p><strong>CNPq</strong><span>8 coord. · 1 part.</span><small>PQ · Universal · INCT</small></p><p><strong>FAPERJ</strong><span>9 coord. · 7 part.</span><small>APQ1 · JCNE · CNE · PRONEM · Sediadas</small></p><p><strong>CAPES</strong><span>1 coord. · 2 part.</span><small>Cooperação bilateral · redes nacionais</small></p><p><strong>FCT/Portugal</strong><span>1 coordenado</span><small>Cooperação científica</small></p><p><strong>UFF/Proppi</strong><span>3 coordenados</span><small>Infralabpesq · Jovens Pesquisadores · FOPESq</small></p><p><strong>Universidade de Sevilha</strong><span>1 coordenado</span><small>Colaboração institucional</small></p></div><p class=\"agency-total\"><strong>Total</strong><span>23 coordenados · 10 participações</span></p>" }
    ],
